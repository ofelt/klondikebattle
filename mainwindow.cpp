...
class PlayersConfig : public QWidget
{
public:
    PlayersConfig(QWidget *parent)
        : QWidget(parent)
    {
        ui.setupUi(this);
    }
...
void MainWindow::showSettings()
{
    ...
    settingsDialog->addPage( new PlayersConfig( settingsDialog ), i18n("Players"), QLatin1String( "games-config-options" ));
    settingsDialog->addPage( new KCardThemeWidget( features, previewFormat ),
                         i18n("Card Deck"),
                         "games-config-theme",
                         i18n("Select a card deck")
                       );
    ...
    KgThemeProvider* provider = Renderer::self()->themeProvider();
    settingsDialog->addPage( new KgThemeSelector(provider),
                         i18n("Game Theme"),
                         "games-config-theme",
                         i18n("Select a theme for non-card game elements")
                       );
